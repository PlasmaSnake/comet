			    ...
			    <div class="card-header">
			  	...
			  	<ul class="list-group">
				    ...
				    <li class="list-group-item">
						<form:form action="addToUserCoins" method="post">
							<input type="hidden" name="coinToAdd" value="<%= coinBasic.getCoin_id()%>"> 
							<button type="submit" value="submit" class="btn btn-success">Add to watch list</button>
						</form:form>
				    </li>
			  	</ul>
			</div>
